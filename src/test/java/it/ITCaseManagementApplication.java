...
import org.lamisplus.modules.casemanagement.CaseManagementApplication;
...
@WebAppConfiguration
@SpringBootTest(classes = { CaseManagementApplication.class, MockMvcConfiguration.class })
@ActiveProfiles("integration-test")
@ContextConfiguration(initializers = MockAcrossServletContextInitializer.class)
public class ITCaseManagementApplication
{
	@Autowired
