...
import org.lamisplus.modules.casemanagement.CaseManagementModule;
...
@WebAppConfiguration
@SpringBootTest(classes = { CaseManagementModule.class, MockMvcConfiguration.class })
@ActiveProfiles("integration-test")
@ContextConfiguration(initializers = MockAcrossServletContextInitializer.class)
public class ITDemoModule
{
	@Autowired
